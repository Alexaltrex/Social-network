...
* Переход от классовых компонент и компонент высшего порядка на функциональные с применением кастомных хуков
...
* Сохранение локальных данных после перезагрузки страницы в url: "use-query-params" v.1.1.9
...
<img src="src/assets/img/profile-status.jpg" width="500">
...
<img src="src/assets/img/profile-edit1.jpg" width="500">
<img src="src/assets/img/profile-edit2.jpg" width="500">
<img src="src/assets/img/profile-edit3.jpg" width="500">
...
##### 3.3.2. Блок управления и информации.
...
##### 3.3.3. Блок пагинации и вида отображения данных.
...
##### 3.3.4. Блок данных о пользователях.
...
##### 3.3.5. Страница с профилем пользователя '/users{id}'.
...
* Список друзей. Каждый элемент списка содержит: аватар, имя-ссылку на страницу профиля друга, кнопку "отправить сообщение" и кнопку, активирующую всплывающее меню со списком команд (удалить из друзей).
...
#### 3.4.2. Вспомогательное боковое меню.
На данный момент с единственный осмысленным пуктом "Друзья".

#### 3.5. Страница "Настройки".
Содержит настройки выбора цвета заднего фона основного заголовка сайта и цвета заднего фона бокового меню и основного контента, а также кнопки сброса к дефолтным значениям.

<img src="src/assets/img/settings1.jpg" width="800">

## Недостатки / что можно еще сделать
* Обработка конкретных случаев сетевых ошибок (пока только отлавливаются, никаких архитекрурных решений не реализовано)
* Замена пагинации на вертикальную прокрутку с подгрузкой
* Поиск постов. Api не позволяет, можно искать среди сообщений из текущего диалога, которые хранятся локально с store
* Отправка сообщений в спам. Api по этому поводу не доделано, можно сделать локально.
* Расширение настроек: цвет кнопок, создание тем.
